...
def eval(model, iterator, case, seed):
    ...
    if args.large:
        save_file = "../out/UAS_finetune_large_{}_{}_{}".format(case, args.hidden_dim, seed)
    else:
        save_file = "../out/UAS_finetune_base_{}_{}_{}".format(case, args.hidden_dim, seed)
    print(save_file)
...
if args.load is None:
    ...
    for epoch in range(args.epochs):
        ...
        optimizer = optim.Adam(model.parameters(), lr=args.learning_rate * (0.95**epoch))
